  ...
  repeat{
    ...
    repeat{
      cat("Do you want to continue testing new predictors?",
          ...
          "  2. Yes, but I want to remove a predictor from the model first",
    ...
    if (opt3 == 3){
      ...
      # TO BE IMPLEMENTED: print the parameters for each variables in the model
      break
    }else if (opt3 == 2){
      ...
      repeat{
        ...
        if (bin == "N"){
          message("Continue modeling with other predictors(OMG)...")
          break
        }
      }
      # break
