...
r.ex <- function(){
  ...
  no.ex <- function(){
    ...
    if (no.set == 0){
      ...
      #---------------#
      cat("\n")
      msm <- "Training Exercise 3.1 - Basic Intro to Graphic Tools"
      message(msm)
      message(rep("-", nchar(msm)))
      message("There are 5 exercises below for this training session.")
      cat("\n")
      ...
      q1 <- 1 # initialize the count of answer times
      repeat{
        cat("Q1. Which statement about plot() is NOT right?",
            "  1. It is usually used to create scatter plot;",
            "  2. Based on the graphic generated by plot(),",
            "     abline() adds a regression line to it;",
            "  3. Arguments 'main' adds both title and subtitle of the plot;",
            "  4. The x of plot(x,...) could be a model formula.",
            "",
            sep = "\n")
        ans <- readline("Your answer: ")
        # ans.bis <- as.numeric(ans)
        if (ans == "3"){
          ...
          if(q1>3){
            message("Oops, game over! Correct answer below:")
            message("The answer is option 3!")
            message("'main' only specifies the title of the plot!")
            message("Let's move to the next question.")
            cat("\n")
            break
          }else{
      ...
      q2 <- 1
      repeat{
        cat("Q2. Regarding boxplot, which statement is TRUE?",
            "  1. Boxplot usually applies on a categorical and a numeric data;",
            "  2. Argument 'staplewex' specifies the width of boxes;",
            "  3. Argument 'horizontal' sets the direction of y-axis labels horizontally;",
            "  4. Argument 'col' in boxplot() cannot be assigned to a vector",
            "", sep = "\n")
        ans <- readline("Your answer: ")
        if (ans == "1"){
          message("Hoorey~ Corret answer!")
          ...
          if (q2>3){
            message("Stop and think, and try it again if you want after all exercises finished.")
            message("The right answer is 1.")
            message("Argument 'horizontal' exchanges the position of y and x axes.")
            cat("\n")
            break
          }else{
            message("Bang-bang! Try again please")
      ...
      q3 <- 1
      repeat{
        cat("Q3. Which command below generates error message?",
            "  1. > mosaicplot(gear ~ carb, data = mtcars)",
            "  2. > mosaicplot(~ gear + carb + cyl, data = mtcars)",
            "  3. > mosaicplot(HairEyeColor, shade = c('red','blue'), cex = 0.5)",
            "  4. > mosaicplot(table(mtcars[,c(10,11)]))",
            "", sep = "\n")
        ...
        if (ans == "3"){
          ...
          if (q3>3){
            message("You have run out of 3 trials...")
            message("The correct answer is option 3!")
            message("'shade' should be assigned by a numeric vector or a logical value")
            cat("\n")
            break
          }else{
            message("Ah-oh~ try again please~")
      ...
      q4 <- 1
      repeat{
        cat("Q4. Which statement below is NOT right concerning hist()?",
            "  1. hist() can be used to plot non-numeric data;",
            "  2. Arguments 'breaks' does not always deliver the number of bars as it is assigned;",
            "  3. Within hist(), if axe = F, then the lines of axes will not be plotted;",
            "  4. Arguments 'border' specifies the color of border of bars.", 
            "", sep = "\n")
        ans <- readline("Your answer (enter the option number): ")
        if (ans == "1"){
          message("One question to go! Ganbade!")
          ...
          if (q4>3){
            message("Oulala~no more chance for this question~")
            message("The correct answer is the 1st option.")
            message("hist() always plots numeric data.")
            cat("\n")
            break
          }else{
            message("Come on~ Try again!")
      ...
      q5 <- 1
      repeat{
        cat("Q5. Which statement below is FALSE:",
            "  1. Some of arguments in function title() can be directly used in other graphic",
            "     funtions without calling title();",
            "  2. xlab and ylab could be assigned by a list (containing other arguments like ",
            "     'cex', 'font', etc.);",
            "  3. If there are 3 boxes in the boxplot, you can assign 2 colors in legend();",
            "  4. The arguments x and y in legend() specifies the coordinates of bottom-right",
            "     corner of the legend box",
            "", sep = "\n")
        ans <- readline("Your answer (no. of line): ")
        if (ans == "4"){
          message("Congratulations! You have finished the exercise 3.1!")
          message("See you in next set of exercises~")
          cat("\n")
          break
        }else if(ans %in% c("1", "2", "3")){
          q5 <- q5 + 1
          
          if (q5>3){
            message("You have tried 3 times...")
            message("The correct answer is 4.")
            message("'x' and 'y' sets the corrdinates of top-left corner of the legend box.")
            message("See you around~")
            cat("\n")
            break
          }else{
      ...
      #---------------#
      cat("\n")
      msm <- "Training Exercise 3.2 - MSU Modeling Tool: AutoReg()"
      message(msm)
      message(rep("-", nchar(msm)))
      message("There is only 1 question below for this training session.")
      cat("\n")
      
      # Question 1
      q1 <- 1 # initialize the count of answer times
      repeat{
        cat("Q1. Which statement about AutoReg() is NOT right?",
            "  1. The file name should always be quoted when you read table by Autoreg()",
            "     from local drive;",
            "  2. To load the raw data, you can firstly import the table by R built-in",
            "     function and assign it to a data frame, then use AutoReg() to read the",
            "     data frame;",
            "  3. If you choose a transformation method for a variable, you cannot try other",
            "     transformation methods for this variable;",
        ...
        if (ans == "3"){
          ...
          if(q1>3){
            message("Oops, game over! Correct answer below:")
            message("The answer is option 3!")
            message("You can always try other transformation method for a variable")
            message("by AutoReg() if you are not satisfied.")
            cat("\n")
            break
          }else{
            message("Bang! Wrong answer! Try again~")
      ...
      cat("Exercise 3.2 statistics:",
          paste("You made ", q1-1, " mistake", if(q1<3){""}else{"s"}, 
                " for the only question.", sep =""),
          "", sep = "\n")
      ...
      message("There are only 10 sets of exercises. Please enter a correct session number!")
    }
